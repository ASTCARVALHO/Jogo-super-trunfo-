...
bib_super_trunfo.remover_cartas(pilha_central, deck_jogador1)
...
bib_super_trunfo.remover_cartas(pilha_central, deck_jogador2)
...
while numero_rodadas <= 4:
    ...
    bib_super_trunfo.modo_de_disputa(deck_jogador1, pick_jogador1)
    bib_super_trunfo.modo_de_disputa(deck_jogador2, pick_jogador2)
    ...
    if caracteristica not in [1, 2, 3]:
        ...
        if pick_jogador1[caracteristica] == pick_jogador2[caracteristica]:
            ...
            bib_super_trunfo.descartar_cartas(pick_jogador1, pilha_de_descarte)
            bib_super_trunfo.descartar_cartas(pick_jogador2, pilha_de_descarte)
